...
public class SOMA_ManageDecision extends Soma_Login{
...
//		Sort		
		...
		WebElement FinalDec = driver.findElement(By.id("edit-final-decision"));
		Select finDecSel	= new Select(FinalDec);
		finDecSel.selectByVisibleText(RandomSelectSOMA.getFinalDec());
		Thread.sleep(2000);
		
		driver.findElement(By.id("edit-letter-sent-datepicker-popup-0")).sendKeys("2017-10-19");
		wait30();
		
		driver.findElement(By.id(RandomSelectSOMA.getPotenFund())).click();
		wait30();
